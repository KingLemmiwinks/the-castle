...
select app_name, id from analytics where id in (1880);
...
select app_name, price from analytics where price between .10 and 1 order by reviews desc limit 10;
...
select * from analytics order by price limit 1;
