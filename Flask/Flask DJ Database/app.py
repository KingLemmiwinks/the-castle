...
def add_song_to_playlist(playlist_id):
    ...
    currently_on_playlist = [song.id for song in playlist.songs]
    form.song.choices = [(song.id, song.title)for song in Song.query.all() if song.id not in currently_on_playlist]
